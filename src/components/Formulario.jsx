            ...
            <form onSubmit={handleSubmit}>
                <div className="my-5">
                    ...
                    <select name="marca" id=""
                        className="w-full p-3 bg-white border border-x-gray-200"
                ...
                <input
                    type="submit"
                    className='w-full bg-blue-500 hover:bg-blue-700 transition-colors text-white cursor-pointer p-3 uppercase font-bold'
                    value='Cotizar'
                />
            </form>
        </>
