...
const Resultado = () => {
    ...
    const yearRef = useRef(year)//no cambia el valor en memoria
    const nombreMarca = useMemo(() =>
        MARCAS.find(m => m.id === Number(marca)),
        [resultado]
    )

    const nombrePlan = useMemo(() =>//no cambia el valor en memoria
    ...
    return (
        <div className="bg-gray-100 text-center mt-5 p-5 shadow rounded">
            ...
            <p className="my-2 text-2xl"><span className="font-bold">Total: </span>{resultado}</p>
